...
download_parser.add_argument("remote_path",type=str)
download_parser.add_argument("--output-path","-o",type=str,required=False)
download_parser.set_defaults(handler = DownloadHandler)
